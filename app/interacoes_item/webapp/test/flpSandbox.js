		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lista de itens de interação",
									"targetURL": "#Listadeitensdeinteração-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Listadeitensdeinteração-display": {
								"semanticObject": "Listadeitensdeinteração",
								"action": "display",
								"description": "Lista de itens de interação",
								"title": "Lista de itens de interação",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=interacoesitem",
									"url": sap.ui.require.toUrl("interacoesitem")
								}
							}
						}
					}
